...
# ✔️ Fully corrected OMEN Smart Money Scanner
# ✔️ Includes:
#    - Load-safe check (nothing runs until file is uploaded)
#    - Strike space fix
        ...
        try:
            ...
            for ticker in top_tickers:
                ...
                filtered = filtered.sort_values(
                    by=['stealth_flag', 'alert_flag', 'premiumvalue'],
                    ascending=[False, False, False]
                )

                if filtered.empty:
                    Story.append(Paragraph(f"⚠️ No trades found for {ticker}.", styles['BodyText']))
